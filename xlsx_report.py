...
def create_xlsxwriter_report(data, filename="roi_report_xlsxwriter.xlsx"):
    ...
    if summary:
        ...
        summary.write_formula("F4", "=E4/(1+B32)^0")
        ...
        summary.write_formula("G5", "=G4+E5")
        summary.write_formula("G6", "=G5+E6")
        summary.write_formula("G7", "=G6+E7")
        summary.write_formula("G8", "=G7+E8")
        for r in range(4, 9):
